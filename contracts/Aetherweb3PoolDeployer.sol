...
import './Aetherweb3Pool.sol';

contract Aetherweb3PoolDeployer is IAetherweb3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc IAetherweb3PoolDeployer
    ...
    function deploy(
        ...
        pool = address(new Aetherweb3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
